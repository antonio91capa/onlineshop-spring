...
<jsp:useBean id="pagedListHolder" scope="request"
	type="org.springframework.beans.support.PagedListHolder"></jsp:useBean>
...
<div class="span9">
	...
	<div class="tab-content">
		<div class="tab-pane" id="listView">
			...
			<div class="row">
				<div class="span2">
					<img src="${pageContext.request.contextPath }/uploads/images/${product.name}" alt="" />
				</div>
				<div class="span4">
					<h3>New | Available</h3>
					<hr class="soft" />
					...
					<a class="btn btn-small pull-right"
						 href="${pageContex.request.contextPath}/product/details/${product.id}">View Details</a> 
					<br class="clr" />
				</div>
				<div class="span3 alignR">
					<form class="form-horizontal qtyFrm">
						...
						<a href="${pageContex.request.contextPath}/cart/buy/${product.id}" 
							class="btn btn-large btn-primary"> 
								Add to <i class=" icon-shopping-cart"></i>
						</a> 
						<a href="${pageContex.request.contextPath}/product/details/${product.id}" 
							class="btn btn-large"><i class="icon-zoom-in"></i>
						</a>
					</form>
				</div>
			</div>
					...
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<h4 style="text-align: center">
								<a class="btn" href="${pageContex.request.contextPath}/product/details/${product.id}"> 
									<i class="icon-zoom-in"></i>
								</a> 
								<a class="btn" href="${pageContex.request.contextPath}/cart/buy/${product.id}">
									Add to <i class="icon-shopping-cart"></i>
								</a> 
								<a class="btn btn-primary" href="${pageContex.request.contextPath}/product/details/${product.id}">$${product.price }</a>
							</h4>
						</div>
					</div>
				</li>
