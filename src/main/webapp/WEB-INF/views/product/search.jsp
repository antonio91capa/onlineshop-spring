		...
		<div class="tab-pane" id="listView">
			...
			<div class="row">
				...
				<div class="span4">
					...
					<a class="btn btn-small pull-right" href="${pageContex.request.contextPath}/product/details/${product.id}">
						View Details</a> 
					<br class="clr" />
				</div>
						...
						<div class="caption">
							...
							<h4 style="text-align: center">
								...
								<a class="btn btn-primary" 
									href="${pageContex.request.contextPath}/product/details/${product.id}">$${product.price }</a>
							</h4>
						</div>
					</div>
				</li>
